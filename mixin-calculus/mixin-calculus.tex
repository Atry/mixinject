...
the RAM machine. This provides a computational foundation for declarative
configuration languages and object-oriented composition mechanisms.
\end{abstract}
...
trie union: merging two records combines their children recursively.

This observation yields an immutable analogue of random-access memory.
...
\end{align*}
The fundamental operations on random-access memory---write, read,
and delete---correspond directly to MixinCalculus primitives:
...
\]
Three observer callbacks build Selectors bottom-up.
